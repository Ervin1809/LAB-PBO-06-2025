...
public class Main {
    ...
    private static void showLoginMenu() {
        ...
        if (userIndex != -1) {
            ...
            if (isPasswordMatch) {
                ...
                showDetailUser(listUserProfile.get(userIndex)); // TODO
                /*
                 * TODO
    ...
    private static void showRegisterMenu() {
        ...
        while (true) {
            ...
            if (password == "") {
                System.out.println("isi coi pwnya");
            } else if (password.length() < 8) {
                System.out.println("Password Kurang Dari 8 Digit");
            } else {
                break;
            }
        }
         ...
         * saat instance User
         */
        Profile profile = new Profile(); // TODO
        /*
         * TODO
        ...
        profile.setFullName(fullName); // TODO
        profile.setAge(age); // TODO
        profile.setHobby(hobby); // TODO
        /*
         * TODO
         ...
         * diinput sebelumnya
         */
        profile.setNickName(StringUtils.getNickName(fullName)); // TODO
        /*
         * TODO
    ...
    private static void showDetailUser(Profile profile) {
        ...
        System.out.println("SELAMAT DATANG !!"); // TODO
        System.out.println("===================="); // TODO
        System.out.println("Nama Lengkap : " + profile.getFullName()); // TODO
        System.out.println("Nama Panggilan : " + profile.getNickName()); // TODO
        System.out.println("Umur : " + profile.getAge()); // TODO
        System.out.println("Hobby : " + profile.getHobby()); // TODO
        /*
         * TODO *
